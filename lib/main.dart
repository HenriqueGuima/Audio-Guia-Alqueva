...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    precacheImage(AssetImage('assets/Alqueva_mapa_app.jpeg'),context);
        ...
        child: Scaffold(
            ...
            body: new Stack(
              children: <Widget>[
                ...
                //GOOGLE MAPS
                Visibility(visible: !isVisible, child: CustomInfoWindowExample()),
                Column(
                          ...
                          child: new Align(
                            ...
                            child: Container(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () => setState(() => isVisible = !isVisible), child:Text(
                                "Navegar \nMapa",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    fontSize: 18,

...
void main() => runApp(CampinhoES());

class CampinhoES extends StatefulWidget {
  CampinhoES({Key? key}) : super(key: key);

  @override
  _CampinhoESState createState() => _CampinhoESState();
}

class _CampinhoESState extends State<CampinhoES> {
              ...
              delegate: SliverChildListDelegate([
                ...
                Column(
                  ...
                  decoration:
                      ...
                      child: ReadMoreText(
                        "La aldea de Campinho se encuentra dentro de la União das Freguesias de Campo e Campinho, en el municipio de Reguengos de Monsaraz, y tiene cerca de unos 700 habitantes (según los censos de 2011). Muy próximos a esta pequeña localidad, encotramos un aeródromo y un fondeadero, por lo que es bastante frecuente visualizar diferentes prácticas deportivas, ya sea de carácter náutico o aeronáutico. Al lado del Lago de Alqueva existe una área recreativa apropiada para que los visitantes disfruten de un picnic, practicar pesca y otras actividades de grupo, disfrutando de la serenidad del espacio. \n\nEn una de las extremidades del núcleo urbano encontramos la Igreja Matriz do Sagrado Coração de Jesus, edificada en el siglo XX, y revelando líneas arquitectónicas típicas del Estado Novo, destacando características como la sobriedad y monumentalidad, propias de esta época histórica. En la torre de la iglesia es posible visualizar las campanas de la Fundação de Braga, con fecha de 1857. Gran parte de la toponomia de esta parroquia está relacionada con los diversos elementos geográficos, por lo que el origen etimológico está asociado con la fisonomía geográfica. A tres quilómetros de la población encontramos la Ermida de Santo Amador, edificada en el monte con el mismo nombre, y que podría ser un punto a incluir en la ruta a realizar por la zona. \n\nLos principales reclamos turísticos de la aldea están relacionados con el turismo cinegético o aquel que busca actividades en el medio natural. \n\nLa aldea de Campinho está incluída en la Reserva DarkSky Alqueva. \n\nSi hay intención de pernoctar en la Aldea de Campinho, la Casa da Junqueira, la Casa Guadiana, la Sorte Verde Alentejo o el Parque de Merendas de Campinho pueden ser buenas opciones. Para saborear los manjares de la región, las propuestas son: el Restaurante Monte de Palaios y el Restaurante Monte d’Açorda. ",
                        style: TextStyle(
                          fontSize: 18,
                          fontFamily: 'Metropolis',
                        ),
  ...
  Future<void> _init() async {
    ...
    try {
      await _player.setAudioSource(
        AudioSource.uri(
          Uri.parse(
              "https://audioguia.s3.eu-west-3.amazonaws.com/Audios/Campinho_es.mp3"),
        ),
      );
    } catch (e) {
